  ...
  return (
    <div className="text-center">
      <div className="flex flex-col gap-4 my-10">
        ...
        <p className="max-w-3xl ml-60">
          Empowering professionals to connect with top employers through a
          seamless job search experience. Advance your career with curated
